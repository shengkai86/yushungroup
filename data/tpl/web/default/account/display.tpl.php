	...
	<div class="clearfix" style="margin-bottom:5em;">
		...
		<?php  if(!$_W['isfounder']) { ?>
			...
			<div class="alert alert-warning">
				...
				可创建 <span class="text-strong"><?php  echo $stat['maxaccount'];?> </span>个公众号，已创建<span class="text-strong"> <?php  echo $stat['uniacid_num'];?> </span>个（包含回收站里面的），还可创建 <span class="text-strong"><?php  echo $stat['uniacid_limit'];?> </span>个公众号。
