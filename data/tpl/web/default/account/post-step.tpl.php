			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						...
						<p class="form-control-static">在微信公众号请求用户网页授权之前，开发者需要先到公众平台网站的【开发者中心】<b>网页服务</b>中配置授权回调域名。<?php  if($_W['isfounder']) { ?><a href="http://www.yushunbox.com/wiki" target="_black">查看详情</a><?php  } ?></p>
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						...
						<?php  echo tpl_edit_sms('balance', $notify['sms']['balance'], $uniacid , url('account/post-step/edit_sms', array('step' => 3)))?>
