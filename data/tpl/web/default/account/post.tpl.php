	...
	<form action="" method="post"  class="form-horizontal" role="form" enctype="multipart/form-data" id="form1">
			...
			<div class="modal-dialog">
				...
				<div class="modal-content" style="width:740px;">
					...
					<div class="modal-body">
						...
						<span class="help-block"><?php  if(IMS_FAMILY == 'x') { ?>欢迎关注<?php  echo $account['name'];?><?php  } else { ?>域顺是一款免费开源的微信公众平台管理系统。<?php  } ?></span>
		...
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-12">
				...
				<p class="form-control-static">在微信公众号请求用户网页授权之前，开发者需要先到公众平台网站的【开发者中心】<b>网页服务</b>中配置授权回调域名。<?php  if($_W['isfounder']) { ?><a href="http://bbs.yushunbox.com//" target="_black">查看详情</a><?php  } ?></p>
