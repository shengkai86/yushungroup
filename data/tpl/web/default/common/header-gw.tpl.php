	...
	<div class="navbar navbar-inverse navbar-static-top" role="navigation" style="z-index:1001; margin-bottom:0;">
		<div class="container-fluid">
			<ul class="nav navbar-nav">
				...
				<?php  if(IMS_FAMILY != 'x') { ?>
				<li><a href="http://bbs.yushunbox.com" target="_blank"><i class="fa fa-comment"></i>论坛</a></li>
				<li><a href="https://mp.weixin.qq.com/" target="_blank"><i class="fa fa-comment"></i>微信公众平台</a></li>
				<li><a href="http://www.yushunbox.com/wiki" target="_blank"><i class="fa fa-suitcase"></i>帮助</a></li>
				<?php  } ?>
			</ul>
			...
			<div class="jumbotron clearfix alert alert-<?php  echo $label;?>">
				<div class="row">
					...
					<div class="col-xs-12 col-sm-8 col-md-9 col-lg-10">
						...
						<?php  } else { ?>
							<p>[<a href="javascript:history.go(-1);" class="alert-link">点击这里返回上一页</a>] &nbsp; [<a href="./index.php?c=user&a=login&" class="alert-link">首页</a>]</p>
						<?php  } ?>
					</div>
				</div>
			</div>
