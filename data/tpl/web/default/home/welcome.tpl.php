...
<ul class="nav nav-tabs">
	...
	<li class="active"><a href="<?php  echo url('home/welcome/' . $do);?>">账号概况 - 扩展功能概况 - 域顺微点餐</a></li>
...
<div class="clearfix welcome-container">
	...
	<?php (!empty($this) && $this instanceof WeModuleSite || 0) ? (include $this->template('home/welcome-fournet', TEMPLATE_INCLUDEPATH)) : (include template('home/welcome-fournet', TEMPLATE_INCLUDEPATH));?>
