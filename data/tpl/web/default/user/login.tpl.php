...
<div class="login">
	...
	<div class="center-block footer" role="footer">
		...
		<div class="text-center">
			...
			<?php  if(empty($_W['setting']['copyright']['footerright'])) { ?><a href="http://www.baidu.com">域顺集团</a>&nbsp;&nbsp;<a href="http://www.baidu.com">域顺金融</a>&nbsp;&nbsp;<a href="http://wpa.b.qq.com/cgi/wpa.php?ln=1&key=XzgwMDA4MzA3NV8zMDk2MDdfODAwMDgzMDc1XzJf">联系客服</a><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerright'];?><?php  } ?> &nbsp; &nbsp; <?php  if(!empty($_W['setting']['copyright']['statcode'])) { ?><?php  echo $_W['setting']['copyright']['statcode'];?><?php  } ?>

		</div>

		<div class="text-center">

			<!-- <?php  if(empty($_W['setting']['copyright']['footerleft'])) { ?>Powered by <a href="http://www.baidu.com"><b>yushun</b></a> v<?php echo IMS_VERSION;?> &copy; 2014-2016 <a href="http://www.baidu.com">www.yushun.com</a><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerleft'];?><?php  } ?> -->
