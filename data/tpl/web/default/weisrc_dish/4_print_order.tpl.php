...
<div class="main">
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <a class="btn btn-primary" href="<?php  echo $this->createWebUrl('PrintOrder', array('op' => 'deleteprintorder', 'storeid' => $storeid))?>" onclick="return confirm('此操作不可恢复，确认操作吗？');return false;">取消未打印订单</a>
        </div>
    </div>
