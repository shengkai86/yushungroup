                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td style="max-width:70px;text-align: center;">
                            <a class="btn btn-default btn-sm" href="<?php  echo $this->createWebUrl('tablezones', array('id' => $item['id'], 'storeid' => $storeid, 'op' => 'post'))?>" title="编辑">编辑</a>
                            <a class="btn btn-danger btn-sm" href="<?php  echo $this->createWebUrl('tablezones', array('id' => $item['id'], 'storeid' => $storeid, 'op' => 'delete'))?>" onclick="return confirm('确认操作吗？');return false;" title="删除">删除</a>
