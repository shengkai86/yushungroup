	...
	<div class="navbar navbar-inverse navbar-static-top" role="navigation" style="position:static;">
		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<li <?php  if($action == 'platform') { ?>class="active"<?php  } ?>>

					<a href="<?php  echo url('home/welcome/platform');?>" target="_blank"><i class="fa fa-mobile"></i>
						基础设置</a>

				</li>

				<!-- <li <?php  if($action == 'ext') { ?>class="active"<?php  } ?>>

					<a href="<?php  echo url('home/welcome/ext');?>" target="_blank"><i class="fa fa-cubes"></i>
						域顺盒子</a>

				</li> -->

				<li <?php  if($module == 'weisrc_dish') { ?>class="active"<?php  } ?>>

					<a href="./index.php?c=home&a=welcome&do=ext&m=weisrc_dish" target="_blank"><i class="fa fa-life-bouy"></i>
						域顺点餐</a>
				...
				<li <?php  if($action == 'mc') { ?>class="active"<?php  } ?>>
					...
					<a href="<?php  echo url('home/welcome/mc');?>" target="_blank"><i class="fa fa-gift"></i>
						粉丝会员</a>

				</li>

				<!-- <li <?php  if($action == 'setting') { ?>class="active"<?php  } ?>>

					<a href="<?php  echo url('home/welcome/setting');?>" target="_blank"><i class="fa fa-umbrella"></i>
						功能选项</a>
				...
				<!-- <li class="active"><a href="./index.php?c=home&amp;a=welcome&amp;do=platform&amp;"><i class="fa fa-cog"></i>基础设置</a></li>
				
					<li><a href="./index.php?c=home&amp;a=welcome&amp;do=site&amp;"><i class="fa fa-life-bouy"></i>微站功能</a></li>
				
					<li><a href="./index.php?c=home&amp;a=welcome&amp;do=mc&amp;"><i class="fa fa-gift"></i>粉丝营销</a></li>
				
					<li><a href="./index.php?c=home&amp;a=welcome&amp;do=setting&amp;"><i class="fa fa-umbrella"></i>功能选项</a></li>
				
					<li><a href="./index.php?c=home&amp;a=welcome&amp;do=ext&amp;"><i class="fa fa-cubes"></i>扩展功能</a></li>
				
					<li><a href="./index.php?c=home&amp;a=welcome&amp;do=members&amp;"><i class="fa fa-cubes"></i>会员套餐</a></li>
				
					<li><a href="./index.php?c=home&amp;a=welcome&amp;do=fournet&amp;"><i class="fa fa-cubes"></i>四网融合</a></li> -->


				<!-- <li <?php  if($action == 'emulator') { ?>class="active"<?php  } ?>>

					<a href="<?php  echo url('utility/emulator');?>" target="_blank"><i class="fa fa-mobile"></i> 模拟测试1</a>

				</li> -->

				<!-- <?php  if(IMS_FAMILY != 'x') { ?>

				<li><a href="http://bbs.yushunbox.com"><i class="fa fa-comment"></i>域顺论坛</a></li>
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-8 col-md-9 col-lg-10">
					...
					<?php  } else { ?>
						...
						<p>[<a href="javascript:history.go(-1);">点击这里返回上一页</a>] &nbsp; [<a href="./index.php?c=user&a=login&">首页</a>]</p>
				...
				<div class="col-xs-12 col-sm-9 col-lg-10">
					...
					<?php  if(CRUMBS_NAV == 1) { ?>
						...
						<ol class="breadcrumb" style="padding:5px 0;">
							...
							<li><a href="<?php  echo url('home/welcome/ext');?>"><i class="fa fa-cogs"></i> &nbsp; 域顺盒子</a></li>
							...
							<li><a href="<?php  echo url('home/welcome/ext', array('m' => $module['name']));?>"><?php  echo $module_types[$module['type']]['title'];?>模块 - 域顺微点餐</a></li>
