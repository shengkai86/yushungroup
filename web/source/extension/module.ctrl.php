...
if($do == 'installed') {
	...
	if (!empty($modules)) {
		...
		foreach ($modules as $mid => $module) {
			...
			$modules[$mid]['official'] = empty($module['issystem']) && (strexists($module['author'], 'yushunbox Team') || strexists($module['author'], '微赞团队'));
...
<manifest xmlns="http://www.yushunbox.com" versionCode="{$versions}">
